...
def vite_asset(entry_name):
    ...
    manifest_path = os.path.join(
        settings.BASE_DIR, 
        'vibe_coding', 'static', 'vibe_coding', 'js', 'dist', 'manifest.json'
    )
...
def vite_chunk_asset(chunk_name):
    ...
    try:
        ...
        for chunk_file in chunk_files:
            asset_url = static(f'vibe_coding/js/dist/{chunk_file}')
