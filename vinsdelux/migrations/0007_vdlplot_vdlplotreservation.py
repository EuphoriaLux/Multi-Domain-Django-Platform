        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Plot name (e.g., 'Hillside Premier')", max_length=200
                    ),
                ),
                (
                    "plot_identifier",
                    models.CharField(
                        help_text="Unique plot identifier (e.g., 'PLT-001')",
                        max_length=50,
                        unique=True,
                    ),
                ),
                ...
                (
                    "vine_age",
                    models.IntegerField(
                        blank=True, help_text="Average age of vines in years", null=True
                    ),
                ),
                (
                    "harvest_year",
