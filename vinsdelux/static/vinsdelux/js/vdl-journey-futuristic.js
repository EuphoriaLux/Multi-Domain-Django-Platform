...
class FuturisticJourney {
     ...
     */
    setupTouchEvents() {
        this.elements.stepsContainer.addEventListener(
            "touchstart",
            (e) => {
    ...
    animateCounters() {
        ...
        const counterElements = [
            ...this.elements.statValues,
            ...this.elements.trustNumbers,
        ];
    ...
    optimizeForPerformance() {
        ...
        if (this.particleSystem) {
            this.particleSystem.maxParticles = Math.max(
                20,
                this.particleSystem.maxParticles * 0.7,
            );
        }
    ...
    updateFPS(deltaTime) {
        ...
        this.performanceMetrics.averageFPS =
            (this.performanceMetrics.averageFPS + fps) / 2;
    }
