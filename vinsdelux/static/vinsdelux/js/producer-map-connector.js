...
(function () {
    ...
    function setupPopupClickHandlers(popup) {
        ...
        setTimeout(() => {
            ...
            const producerName =
                tempDiv.querySelector("h5")?.textContent ||
            ...
            if (!tempDiv.querySelector(".select-producer-btn")) {
                ...
                button.innerHTML =
                    '<i class="fas fa-wine-bottle"></i> View Available Plots';
    ...
    document.addEventListener("click", function (e) {
        if (
            e.target.matches(
                ".view-adoption-plans, .select-producer, [data-producer-name]",
            )
        ) {
            e.preventDefault();

            const producerName =
                e.target.dataset.producerName ||
            ...
            if (producerName) {
                const producerData = {
                    ...
                    description:
                        e.target.dataset.description || "Premium wine producer",
                };
