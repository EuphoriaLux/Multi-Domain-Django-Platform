        ...
        if (typeof PlotSelection !== "undefined") {
            this.components.plotSelection = new PlotSelection({
                ...
                onSelectionLimitReached: (limit) =>
                    this.handleSelectionLimitReached(limit),
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (
        document.body.classList.contains("vinsdelux-page") ||
        ...
        if (config.debug) {
            window.VineyardMap =
                typeof VineyardMap !== "undefined" ? VineyardMap : null;
            window.PlotSelection =
                typeof PlotSelection !== "undefined" ? PlotSelection : null;
            window.VineyardAnimations =
                typeof VineyardAnimations !== "undefined" ? VineyardAnimations : null;
        }
    }
});
