    ...
    document.addEventListener("DOMContentLoaded", function () {
            ...
            .then((data) => {
                ...
                if (data.plans && Array.isArray(data.plans)) {
                    data.plans.forEach((plan, index) => {
                        const location =
                            luxembourgLocations[index % luxembourgLocations.length];
                        ...
                        const producerName = plan.producer
                            ? plan.producer.name
                            : plan.producer_name || plan.name;
                        const popupContent = `
                    ...
                    const producers = [
                        {
                            ...
                            specialty: "Cabernet Sauvignon blends",
                        },
                        {
        ...
        document.addEventListener("click", function (e) {
            if (e.target.classList.contains("select-producer-btn")) {
                ...
                const selectionDisplay = document.getElementById(
                ...
                setTimeout(function () {
                    ...
                    const adoptionSection = document.getElementById(
            ...
            fetch(`/${langCode}/vinsdelux/api/adoption-plans/`)
                ...
                .then((data) => {
                    ...
                    if (plans) {
                        ...
                        const centerClass =
                            relevantPlans.length === 1 ? "justify-content-center" : "";
                        let plansHTML = `<div class="row ${centerClass}">`;
                        relevantPlans.forEach((plan) => {
                            const coffrets =
                                plan.coffrets_per_year || plan.bottles_per_year || 2;
                            plansHTML += `
                ...
                .catch((error) => {
                    ...
                    planContainer.innerHTML =
                        "<p>Error loading adoption plans. Please try again.</p>";
                });
        }
