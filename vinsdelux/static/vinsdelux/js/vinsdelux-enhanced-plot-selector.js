...
class EnhancedPlotSelector {
    ...
    setupEventListeners() {
        ...
        document
            .getElementById("selectPlotBtn")
            ?.addEventListener("click", () => this.selectCurrentPlot());
    ...
    showPlotDetails(plot) {
        ...
        document.getElementById("plotStatus").textContent = plot.available
            ? "Available"
            : "Unavailable";
        ...
        benefitsList.innerHTML = plot.benefits
            .map(
                (benefit) =>
        ...
        document
            .querySelector(`.plot-marker[data-plot-id="${plot.id}"]`)
    ...
    showCantonInfo(canton) {
        ...
        this.showNotification(
            `Selected canton: ${cantonNames[canton]}. Wine plots coming soon!`,
        );
    }
