...
class VdlAdoptionPlanSerializer(serializers.ModelSerializer):
    ...
    coffret_name = serializers.CharField(
        source="associated_coffret.name", read_only=True
    )
...
class VdlPlotReservationSerializer(serializers.ModelSerializer):
    ...
    plot_identifier = serializers.CharField(
        source="plot.plot_identifier", read_only=True
    )
