...
class ContainerAuditor:
    ...
    def audit_container(self, container_name):
        ...
        try:
            ...
            if not container_client.exists():
                print(f"WARNING:  Container '{container_name}' does not exist")
                return
            ...
            if total_blobs == 0:
                print(f"OK: Container '{container_name}' is EMPTY - Safe to delete!")
                return
            ...
            print(f"ERROR: Error auditing container '{container_name}': {e}")
            import traceback
            traceback.print_exc()
    ...
    def print_container_summary(self, container_name):
        ...
        if unknown_blobs:
            print(f"\nWARNING:  WARNING: {len(unknown_blobs)} blobs with unknown platform!")
    ...
    def generate_report(self):
        ...
        if media_blobs == 0 and staging_blobs == 0:
            print("OK: SAFE TO DELETE: Both containers are empty!")
            print("\nRun these commands:")
            ...
            print("WARNING:  NOT SAFE TO DELETE: Containers contain data!")
            ...
            if unknown_count > 0:
                print(f"\nWARNING:  CRITICAL: {unknown_count} blobs have UNKNOWN platform assignment!")
...
def main():
    ...
    try:
        ...
        print("\n\nWARNING:  Audit cancelled by user")
        sys.exit(1)
    except Exception as e:
