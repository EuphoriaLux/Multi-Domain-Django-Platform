...
from entreprinder.finops.models import CostExport, CostRecord
from entreprinder.finops.utils.blob_reader import AzureCostBlobReader
from entreprinder.finops.utils.focus_parser import FOCUSParser
import traceback
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if total_records_imported > 0 and not skip_aggregation:
                ...
                try:
                    from entreprinder.finops.utils.aggregation import CostAggregator
