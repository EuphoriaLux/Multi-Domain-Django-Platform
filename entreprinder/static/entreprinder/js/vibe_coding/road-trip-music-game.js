...
class RoadTripMusicGame {
    constructor() {
        ...
        this.musicLibrary = {
            ...
            opening: {
                ...
                description:
                    "Every journey needs a soundtrack. What gets you in the mood for adventure?",
                options: [
                    {
                        ...
                        myChoice: {
                            title: "Hips Don't Lie - Shakira",
                            youtube: "DUT5rEU6pqM",
                            year: "2006",
                            message:
                                "This was playing everywhere when we were teenagers!",
                        },
                    },
                    {
                        ...
                        myChoice: {
                            ...
                            youtube: "8vfKUe4sQBE",
                            year: "2015",
                            message: "This is how I feel about us reconnecting.",
                        },
                    },
                    {
                        ...
                        myChoice: {
                            ...
                            youtube: "G7KNmW9a75Y",
                            year: "2023",
                            message: "Sometimes you need to dance it out!",
                        },
                    },
                ],
                maxiResponse:
                    "Music has always been special to me. I'll share some of my favorites...",
            },
            ...
            phase1: {
                ...
                description:
                    "We've talked about then and now. What music captures those feelings?",
                options: [
                    {
                        ...
                        myChoice: {
                            ...
                            year: "2006",
                            message:
                                "This song understood me during my complicated times.",
                        },
                    },
                    {
                        ...
                        myChoice: {
                            ...
                            year: "2005",
                            message:
                                "This is how today feels - like everything is starting fresh.",
                        },
                    },
                    {
                        ...
                        songs: [
                            ...
                            {
                                title: "Somebody Told Me - The Killers",
                                youtube: "Y5fBdpreJiU",
                                year: "2004",
                            },
                            {
                                title: "Time to Dance - The Sounds",
                                youtube: "PIb6AZdTr-A",
                                year: "2002",
                            },
                        ],
                        myChoice: {
                            ...
                            year: "2007",
                            message:
                                "This is what being around you feels like - electric.",
                        },
                    },
                ],
                maxiResponse:
                    "Your music taste says so much about who you are. Here's what moves me...",
            },
            ...
            phase2: {
                ...
                description:
                    "Music that got us through the tough times and made us who we are.",
                options: [
                    {
                        ...
                        myChoice: {
                            ...
                            year: "2016",
                            message:
                                "This is who I became after everything - unstoppable.",
                        },
                    },
                    {
                        genre: "Healing Soul",
                        ...
                        myChoice: {
                            ...
                            year: "2002",
                            message:
                                "Sometimes you need to just be still and let healing happen.",
                        },
                    },
                    {
                        ...
                        myChoice: {
                            ...
                            year: "2017",
                            message:
                                "This song represents my journey from pain to power.",
                        },
                    },
                ],
                maxiResponse:
                    "We've both been through so much. Music helped us survive and thrive...",
            },
            ...
            phase3: {
                ...
                description:
                    "As we approach the deeper mysteries of connection, what sounds resonate with your soul? Choose music that bridges earth and stars.",
                options: [
                    {
                        ...
                        songs: [
                            {
                                ...
                                youtube: "UfcAVejslrU",
                                year: "2011",
                                message: "Floating into the cosmic unknown together 🌌",
                            },
                            {
                                ...
                                year: "1978",
                                message:
                                    "Where earthbound meets infinite... like us 🌍→🌌",
                            },
                            {
                                ...
                                year: "2019",
                                message:
                                    "Something magical is beginning to take flight ✨",
                            },
                        ],
                        myChoice: {
                            ...
                            year: "1969",
                            message:
                                "Ground Control to Major Tom... are you ready for cosmic connection? 🚀",
                        },
                    },
                    {
                        ...
                        songs: [
                            {
                                title: "Svefn-g-englar - Sigur Rós",
                                youtube: "8LeQN249Jqw",
                                year: "1999",
                                message:
                                    "Angels speak in frequencies only the heart understands 👼",
                            },
                            {
                                title: "Your Hand in Mine - Explosions in the Sky",
                                youtube: "JzIK5FaC38w",
                                year: "2003",
                                message:
                                    "When the universe feels alive and breathing with possibility 🌍💫",
                            },
                            {
                                title: "Glósóli - Sigur Rós",
                                youtube: "Bz8iEJeh26E",
                                year: "2005",
                                message:
                                    "Like jumping in puddles... but the puddles are made of starlight ⭐",
                            },
                        ],
                        myChoice: {
                            ...
                            year: "1905",
                            message:
                                "Moonlight sonata for two souls preparing to explore the cosmos 🌙",
                        },
                    },
                    {
                        ...
                        songs: [
                            {
                                title: "Time - Hans Zimmer",
                                youtube: "RxabLA7UQ9k",
                                year: "2010",
                                message:
                                    "Every second builds toward this cosmic moment ⏰",
                            },
                            {
                                title: "Planet Earth - BBC Earth",
                                youtube: "xNBNPtYjma8",
                                year: "2006",
                                message:
                                    "Seeing our whole world from space... perspective shift 🌍",
                            },
                            {
                                title: "Aqueous Transmission - Incubus",
                                youtube: "eQK7KSTQfaw",
                                year: "2001",
                                message:
                                    "Floating toward something greater than ourselves 🌊",
                            },
                        ],
                        myChoice: {
                            title: "There Will Be Blood - Jonny Greenwood",
                            youtube: "3M-bOr8R5vE",
                            year: "2007",
                            message:
                                "The orchestra of the universe tuning up for our cosmic symphony 🎼",
                        },
                    },
                    {
                        ...
                        songs: [
                            {
                                title: "Also sprach Zarathustra - Richard Strauss",
                                youtube: "IFPwm0e_K98",
                                year: "1896",
                                message:
                                    "The dawn of something cosmic and inevitable 🌅",
                            },
                            {
                                ...
                                year: "2014",
                                message:
                                    "What if heaven is just two people understanding each other perfectly? 👼",
                            },
                            {
                                title: "Saturn - Sleeping At Last",
                                youtube: "h3lWwMHFhnA",
                                year: "2013",
                                message: "When planets align... just like we did 🪐",
                            },
                        ],
                        myChoice: {
                            ...
                            youtube: "SNQRiiocNx8",
                            year: "2014",
                            message: "Running toward infinity... together 🌾🚀",
                        },
                    },
                ],
                maxiResponse:
                    "I feel the universe pulling us toward something bigger... like we're about to discover what the stars have been whispering all along 🌌✨",
            },
            ...
            phase4: {
                ...
                description:
                    "When Air meets Water in the cosmic dance, what sounds emerge? Let the universe guide your musical selection for this mystical moment.",
                options: [
                    {
                        ...
                        myChoice: {
                            ...
                            year: "1977",
                            message:
                                "Like Pisces intuition meeting Gemini curiosity among the stars ✨",
                        },
                    },
                    {
                        ...
                        myChoice: {
                            ...
                            year: "2009",
                            message:
                                "Your cosmic love pulls me like the moon pulls the tides 🌙",
                        },
                    },
                    {
                        genre: "Dreamy Indie",
                        ...
                        myChoice: {
                            ...
                            year: "2006",
                            message:
                                "Far away from the memories of the people who care if I live or die - just us and the stars ⭐",
                        },
                    },
                    {
                        ...
                        songs: [
                            ...
                            {
                                title: "Come On Eileen - Dexys Midnight Runners",
                                youtube: "oc-P8oDuS0Q",
                                year: "1982",
                            },
                        ],
                        myChoice: {
                            title: "Aquarius - The 5th Dimension",
                            youtube: "kjxSCAalsBE",
                            year: "1969",
                            message:
                                "This is the dawning of the Age of Aquarius... and our cosmic connection 🌟",
                        },
                    },
                ],
                maxiResponse:
                    "The stars have aligned our musical tastes... what does this cosmic synchronicity mean? 🌌♊♓",
            },
            ...
            phase5: {
                ...
                description:
                    "The perfect soundtrack for roleplay and intimate exploration. These songs set the mood for when imagination meets desire.",
                options: [
                    {
                        genre: "Sensual R&B",
                        ...
                        songs: [
                            {
                                title: "Earned It - The Weeknd",
                                youtube: "waU75jdUnYw",
                                year: "2014",
                            },
                            {
                                title: "Body Party - Ciara",
                                youtube: "B9rSBcoX9ak",
                                year: "2013",
                            },
                            {
                                title: "Pretty Hurts - Beyoncé",
                                youtube: "LXXQLa-5n5w",
                                year: "2013",
                            },
                        ],
                        myChoice: {
                            ...
                            year: "1996",
                            message:
                                "Classic seduction vibes... you know what this means 😏",
                        },
                    },
                    {
                        genre: "Sultry Jazz",
                        ...
                        songs: [
                            {
                                title: "I Put a Spell on You - Nina Simone",
                                youtube: "ua2k52n_Bvw",
                                year: "1965",
                            },
                            {
                        ...
                        myChoice: {
                            title: "The Way You Look Tonight - Tony Bennett",
                            youtube: "h9ZGKALMMuc",
                            year: "1995",
                            message:
                                "For when we're playing elegant strangers at that hotel bar 🍸",
                        },
                    },
                    {
                        ...
                        songs: [
                            ...
                            {
                                title: "Wild Thoughts - DJ Khaled ft. Rihanna",
                                youtube: "fyaI4-5849w",
                                year: "2017",
                            },
                        ],
                        myChoice: {
                            title: "Work from Home - Fifth Harmony",
                            youtube: "5GL9JoH4Sws",
                            year: "2016",
                            message:
                                "This is pure fire... perfect motivation for our elevator scenario 🔥",
                        },
                    },
                    {
                        ...
                        myChoice: {
                            title: "Lost in the Light - Bahamas",
                            youtube: "VEpMj-tqixs",
                            year: "2014",
                            message:
                                "For those tender moments between the roleplay... when it gets real 💫",
                        },
                    },
                ],
                maxiResponse:
                    "These songs... they're making me imagine all sorts of scenarios with you. Should we explore some of them? 🎭💋",
            },
        };
        ...
        this.phases = [
            {
                ...
                description:
                    "Let's explore how we've both grown since that party 16 years ago. Some things change, some stay the same, and some get better with time.",
                questions: [
                    {
                        text: "Maxi, when we were 16 at that party, what do you remember most about that night?",
                        maleResponse:
                            "I remember thinking you had this confidence that was different from other girls our age. And honestly, I had a bit of a crush but was too shy to do anything about it back then.",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "She'd probably be shocked that I finally got the courage to ask you out, even if it took 16 years! And she'd be proud that I'm not the awkward teenager anymore.",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "I've learned to be more direct about what I want and not waste time on things that don't matter. Life's too short to play games or settle for 'good enough.'",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "The feeling that anything could happen at any moment. That excitement when you'd get ready to go out, not knowing who you'd meet or what adventure awaited.",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "Don't wait for the 'perfect moment' to tell someone how you feel. And trust your gut - if something feels off in a relationship, it probably is.",
                        options: [
            ...
            },
            {
                ...
                description:
                    "We've both been through relationships that shaped us. Let's talk about what we've learned and how it's made us who we are today.",
                questions: [
                    {
                        text: "How has being a mother figure to that little girl changed you?",
                        maleResponse:
                            "I imagine it's made you incredibly strong and shown you what unconditional love really looks like. That kind of bond is rare and beautiful.",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "I can only imagine how strange it must be - being in a space that holds so many memories while trying to move forward. That takes incredible strength.",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "Sometimes you can give everything to someone and it still isn't enough - but that doesn't mean you should give less, it means you should choose better.",
                        options: [
                            ...
                            {
                                text: "Some people aren't ready for real love",
                                points: 3,
                            },
                        ],
                    },
                    {
                        ...
                        maleResponse:
                            "For me, it's moments like this - good conversation, new adventures, and being around people who see the real me, not just the version shaped by past relationships.",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "I think they'd be surprised by the detours, but proud that we didn't let the tough times break us. Maybe they'd even be excited that we found our way back to each other.",
                        options: [
            ...
            },
            {
                ...
                description:
                    "The past shaped us, the present brought us here, but what about tomorrow? Let's explore what we're both looking for in this next chapter.",
                questions: [
                    {
                        text: "When you imagine your ideal living situation, what does it look like?",
                        maleResponse:
                            "A place that feels like home, not just a house. Somewhere I can host people I care about, with good natural light and space for both solitude and connection.",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "Someone who's been through enough to appreciate genuine connection, who can handle both the fun times and the real stuff. Someone ready for depth, not just surface.",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "They'd need to understand that I come with history, but I'm not broken. I know what I want now and I won't settle for less than I deserve.",
                        options: [
                            { text: "I have history but I'm not broken", points: 5 },
                            { text: "I know what I want now", points: 5 },
                            {
                                text: "I come as a package with responsibilities",
                                points: 4,
                            },
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "Honestly? This. Getting to know you again, seeing if there's still that spark I felt all those years ago, and maybe writing a completely new chapter.",
                        options: [
                    ...
                    },
                    {
                        ...
                        maleResponse:
                            "Something where we can talk for hours without interruption. Maybe a weekend somewhere new, where we can explore both the place and whatever this is between us.",
                        options: [
            ...
            },
            {
                ...
                description:
                    "The stars aligned to bring an Air sign and Water sign together. Let's explore what the universe has in store for this cosmic duo.",
                questions: [
                    {
                        text: "When the stars align for a perfect evening, what happens?",
                        maleResponse:
                            "I think it's those magical moments where time stops - whether we're having deep conversations under actual stars or just getting lost in each other's thoughts.",
                        options: [
                            {
                                text: "Deep philosophical conversations under the stars ♓",
                                points: 4,
                            },
                            {
                                text: "Spontaneous adventure to three different places ♊",
                                points: 4,
                            },
                            {
                                text: "A mix of both - deep talks during a midnight drive ⭐",
                                points: 5,
                            },
                            {
                                text: "Netflix and analyzing the hidden meanings in movies 🎭",
                                points: 3,
                            },
                        ],
                    },
                    {
                        ...
                        maleResponse:
                            "I've learned that sometimes the best decisions come from combining gut feelings with practical thinking. Your intuition might catch what my analysis misses.",
                        options: [
                            { text: "Trust the gut feeling completely ♓", points: 4 },
                            {
                                text: "Make pro/con lists and debate all options ♊",
                                points: 4,
                            },
                            {
                                text: "Feel it out first, then think it through ⭐",
                                points: 5,
                            },
                            {
                                text: "Flip a coin after extensive discussion 🎲",
                                points: 3,
                            },
                        ],
                    },
                    {
                        ...
                        maleResponse:
                            "I love how we can switch between playful banter and meaningful silence. Sometimes the best conversations happen without words.",
                        options: [
                            {
                                text: "Express through art, music, or meaningful silences ♓",
                                points: 4,
                            },
                            {
                                text: "Talk it out with animated gestures and multiple perspectives ♊",
                                points: 4,
                            },
                            {
                                text: "Write long thoughtful messages then discuss them ⭐",
                                points: 5,
                            },
                            {
                                text: "Communicate through memes and inside jokes 📱",
                                points: 3,
                            },
                        ],
                    },
                    {
                        ...
                        maleResponse:
                            "I'd probably start making escape plans while you're finding the most peaceful spot on the beach. Somehow we'd end up creating the perfect balance of planning and zen.",
                        options: [
                            {
                                text: "Build a zen meditation garden and wait for rescue ♓",
                                points: 4,
                            },
                            {
                                text: "Create 15 different escape plans and signal systems ♊",
                                points: 4,
                            },
                            {
                                text: "Combine intuition about weather with logical planning ⭐",
                                points: 5,
                            },
                            {
                                text: "Start a philosophical island podcast 🏝️",
                                points: 3,
                            },
                        ],
                    },
                    {
                        ...
                        maleResponse:
                            "It's like creating beautiful chaos that somehow works perfectly. Your depth grounds my energy, and maybe my curiosity brings out new sides of you.",
                        options: [
                            {
                                text: "Find peace in shared silence and understanding ♓",
                                points: 4,
                            },
                            {
                                text: "Keep each other endlessly entertained with new ideas ♊",
                                points: 4,
                            },
                            {
                                text: "Create beautiful chaos that somehow works perfectly ⭐",
                                points: 5,
                            },
                            {
                                text: "Discover that opposites really do attract 💫",
                                points: 3,
                            },
                        ],
                    },
            ...
            },
            {
                ...
                description:
                    "Time to get creative and explore some fun 'what if' scenarios. These playful roleplay questions let us imagine different dynamics and desires.",
                questions: [
                    {
                        text: "Scenario: We're at a fancy hotel bar, and you're pretending we just met. What's your opening line?",
                        maleResponse:
                            "I'd probably say something like 'I don't usually do this, but I couldn't help noticing how you light up this whole room. Mind if I buy you a drink and find out if you're as interesting as you are beautiful?'",
                        options: [
                            {
                                text: "'Is that seat taken, or are you waiting for someone special?' 😏",
                                points: 4,
                            },
                            {
                                text: "'I love your energy from across the room. I'm [fake name]' ✨",
                                points: 5,
                            },
                            {
                                text: "'What's a person like you doing in a place like this?' 🍸",
                                points: 3,
                            },
                            {
                                text: "Just make intense eye contact and see if you approach 👁️",
                                points: 4,
                            },
                        ],
                    },
                    {
                        ...
                        maleResponse:
                            "I'd make something that requires feeding you by hand - chocolate-covered strawberries, maybe some tapas we can share. It's not about the food, it's about the intimacy of the moment.",
                        options: [
                            {
                                text: "Aphrodisiac feast: oysters, chocolate, wine 🦪",
                                points: 5,
                            },
                            {
                                text: "Hand-fed fruits and sensual finger foods 🍓",
                                points: 5,
                            },
                            {
                                text: "Cook together - pasta while dancing in kitchen 🍝",
                                points: 4,
                            },
                            {
                                text: "Order takeout and focus on other appetites 😈",
                                points: 3,
                            },
                        ],
                    },
                    {
                        ...
                        maleResponse:
                            "I'd want you to start with my shoulders and work your way down slowly. And my safe word would be... 'more please.' Wait, that doesn't sound very safe, does it?",
                        options: [
                            {
                                text: "Start with shoulders, safe word: 'paradise' 🌴",
                                points: 4,
                            },
                            {
                                text: "Begin with hands, safe word: 'breathe' 🫁",
                                points: 3,
                            },
                            {
                                text: "Focus on back, safe word: 'starlight' ⭐",
                                points: 4,
                            },
                            {
                                text: "Full body, safe word: 'more' (rebel alert!) 😈",
                                points: 5,
                            },
                        ],
                    },
                    {
                        ...
                        maleResponse:
                            "First, I'd make sure you're comfortable. Then I'd probably suggest we play '20 questions' but with increasingly personal questions. By hour two, we'd either know everything about each other or...",
                        options: [
                            {
                                text: "Deep conversation and philosophical discussions 🧠",
                                points: 3,
                            },
                            {
                                text: "Truth or dare with escalating stakes 🎯",
                                points: 5,
                            },
                            {
                                text: "Create elaborate fantasies about our escape 🗝️",
                                points: 4,
                            },
                            {
                                text: "See how creative we can get in small spaces 😏",
                                points: 5,
                            },
                        ],
                    },
                    {
                        ...
                        maleResponse:
                            "I'd choose something that makes you feel powerful but approachable. Something that highlights your best features while staying true to who you are. The goal is confidence.",
                        options: [
                            {
                                text: "Elegant and sophisticated - little black dress energy 🖤",
                                points: 4,
                            },
                            {
                                text: "Edgy and confident - leather jacket badass vibes 🔥",
                                points: 5,
                            },
                            {
                                text: "Soft and romantic - flowing fabrics and gentle colors 🌸",
                                points: 3,
                            },
                            {
                                text: "Bold and daring - something that turns heads 👀",
                                points: 5,
                            },
                        ],
                    },
    ...
    setupEventListeners() {
        ...
        document.getElementById("nextPhaseButton")?.addEventListener("click", () => {
            ...
            if (this.isVotingCompleted()) {
                ...
                alert(
                    "Please complete the music evaluation by voting on Tom's choice first.",
                );
            }
        });
    ...
    showMusicSelection(round) {
        ...
        if (
            !musicData.options ||
            !Array.isArray(musicData.options) ||
            musicData.options.length === 0
        ) {
            console.error(
                `🚨 Invalid music data structure for round ${round}:`,
                musicData,
            );
            return;
        }
        ...
        musicData.options.forEach((option, index) => {
            ...
            genreCard.className =
                "genre-card bg-white border-2 border-gray-200 rounded-xl p-4 cursor-pointer hover:border-purple-400 transition-all duration-300";
            genreCard.innerHTML = `
            ...
            genreCard.addEventListener("click", () =>
                this.selectMusicGenre(round, index),
            );
            genreContainer.appendChild(genreCard);
        });

        // Show Maxi's teaser
        document.getElementById("musicResponseTeaser").textContent =
            musicData.maxiResponse;
    ...
    selectMusicGenre(round, genreIndex) {
        ...
        if (typeof genreIndex !== "number" || genreIndex < 0) {
            console.error(
                "🚨 Invalid genreIndex parameter in selectMusicGenre:",
                genreIndex,
            );
            return;
        }
        ...
        if (genreIndex >= musicData.options.length) {
            console.error(
                `🚨 Genre index ${genreIndex} out of bounds for round ${round}. Max index: ${musicData.options.length - 1}`,
            );
            return;
        }
    ...
    showMusicPlayer(genreData, round) {
        ...
        console.log(
            "Showing popup overlay for first song selection from",
            genreData.genre,
        );
    ...
    continueAfterMusic() {
        console.log(
            "🎵 continueAfterMusic called. Current round:",
            this.currentMusicRound,
        );
        console.log("🎮 Current phase:", this.currentPhase);
        console.log("🎶 Songs played so far:", this.currentPhaseData.songsPlayed);
        console.log(
            "🎵 Played songs from current genre:",
            this.playedSongsFromCurrentGenre,
        );
        ...
        const playerContainer = document.getElementById("musicPlayerContainer");
        const isShowingMusicSelection =
            musicSelectionScreen && !musicSelectionScreen.classList.contains("hidden");
        const isPlayerHidden =
            playerContainer && playerContainer.classList.contains("hidden");

        if (isShowingMusicSelection && isPlayerHidden) {
            console.error(
                "🚨 CRITICAL: continueAfterMusic called while music selection screen is active!",
            );
        ...
        if (
            ...
            this.currentPhaseData.songsPlayed.length === 0
        ) {
            ...
            if (
                ...
                this.currentMusicRound <= musicRounds.length
            ) {
        ...
        if (this.currentMusicRound >= 1 && this.currentMusicRound <= 5) {
            ...
            console.log(
                `🎮 Moving to Phase ${targetPhase + 1} questions (phase index ${targetPhase}). Songs from music round ${this.currentMusicRound}:`,
                this.currentPhaseData.songsPlayed,
            );
            this.showPhaseIntro();
        } else {
    ...
    showPhaseIntro() {
        ...
        if (this.currentPhase < 0 || this.currentPhase >= this.phases.length) {
            console.error(
                `🚨 Invalid currentPhase: ${this.currentPhase}. Valid range: 0-${this.phases.length - 1}`,
            );
            return;
        }
        ...
        document.getElementById("phaseDescription").querySelector("p").textContent =
            phase.description;
    ...
    startPhase() {
        ...
        console.log(
            "🎶 Songs available at phase start:",
            this.currentPhaseData.songsPlayed.length,
        );
        ...
        console.log(
            "Phase started preserving",
            existingSongs.length,
            "songs from music selection",
        );
    ...
    showQuestion() {
        ...
        console.log(
            `❓ Showing Question ${questionNumber}/${phaseQuestionTotal} from Phase ${phase.id}: "${phase.title}"`,
        );
        ...
        document.getElementById("questionCounter").textContent =
            `Question ${questionNumber}/${phaseQuestionTotal}`;
        ...
        question.options.forEach((option, index) => {
            ...
            button.className =
                "answer-button w-full text-left p-4 bg-white border-2 border-gray-200 rounded-xl hover:border-purple-400 transition-all duration-300";
    ...
    showPhaseComplete() {
        ...
        console.log(
            "About to show phase summary. allSongsPlayedInPhase:",
            this.allSongsPlayedInPhase,
        );
        ...
        if (staticButton) {
            ...
            if (votingCompleted) {
                ...
                staticButton.className =
                    "w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold py-4 rounded-xl hover:from-pink-600 hover:to-purple-700 transition-all";
                staticButton.textContent =
                    this.currentPhase === 4
                        ? "Complete Journey"
            ...
            console.log(
                "🔘 Updated static nextPhaseButton - voting completed:",
                votingCompleted,
            );
        } else {
            console.log(
                "🔘 nextPhaseButton not found in DOM (expected if voting not completed)",
            );
        }
    }
    ...
    nextPhase() {
        ...
        console.log(
            "🎵 Current music round before transition:",
            this.currentMusicRound,
        );
        console.log("💾 Saving phase data before reset:", this.currentPhaseData);
        console.log(
            `📊 Phase ${this.currentPhase + 1} Score: ${this.phaseScores[this.currentPhase]} points`,
        );
        ...
        if (this.currentPhaseData.questions.length > 0) {
            ...
            const alreadySaved = this.phaseSummaries.some(
                (summary) => summary.phaseTitle === phase.title,
            );
        ...
        console.log(
            `🎮 Phase ${this.currentPhase + 1} questions complete, determining next step...`,
        );
        ...
        if (this.currentPhase === 0) {
            ...
            console.log(
                `🎵 Phase 4 questions completed - showing Phase 5 music selection (round ${this.currentMusicRound})`,
            );
            ...
            console.error(
                "🚨 Unexpected phase index in nextPhase():",
                this.currentPhase,
            );
            this.stopBackgroundMusic();
            this.showSimpleCompletion();
    ...
    showFinalResults() {
        ...
        if (percentage >= 90) {
            ...
            message =
                "The stars have perfectly aligned! Pisces intuition and Gemini curiosity create an unbreakable cosmic bond. Your souls dance together across the galaxy - from teenage dreams to celestial realities.";
        } else if (percentage >= 80) {
            emoji = "✨";
            compatibilityTitle = "Stellar Connection ♓⭐♊";
            message =
                "Jupiter blesses this union! Your Pisces depth beautifully complements Gemini's sparkling wit. The universe wrote your love story in constellations long before you met.";
        } else if (percentage >= 70) {
            emoji = "🌟";
            compatibilityTitle = "Celestial Harmony ♓🌙♊";
            message =
                "Venus whispers your compatibility! Pisces dreams and Gemini adventures create a magical symphony. Your astrological match transcends earthly understanding.";
        } else if (percentage >= 60) {
            emoji = "🌙";
            compatibilityTitle = "Cosmic Chemistry ♓🔮♊";
            message =
                "Mercury approves your connection! The mystical Fish and clever Twins share secrets the universe intended. Your compatibility sparkles like distant starlight.";
        } else {
            emoji = "🔮";
            compatibilityTitle = "Cosmic Journey ♓🌠♊";
            message =
                "Every constellation has its story! Pisces and Gemini may orbit differently, but your unique cosmic dance creates its own beautiful pattern in the stars.";
        }
        ...
        compatibilityDiv.className =
            "text-lg font-semibold text-purple-600 mb-2 zodiac-symbol";
        compatibilityDiv.textContent = compatibilityTitle;

        const finalPercentageElement = document.getElementById("finalPercentage");
        finalPercentageElement.parentNode.insertBefore(
            compatibilityDiv,
            finalPercentageElement,
        );

        document.getElementById("finalMessage").querySelector("p").textContent =
            message;
    ...
    showSimpleCompletion() {
            ...
            <div class="screen fade-in">
                <div class="bg-white rounded-3xl p-8 card-shadow slide-up">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 mb-4">
                        ...
                        <button id="savePlaylistButton" class="w-full bg-white text-purple-600 font-medium py-2 rounded-lg text-sm hover:bg-purple-50 transition">
                            🎵 Save Our Playlist
                        </button>
                    </div>
        ...
        // Add restart and playlist functionality
        setTimeout(() => {
    ...
    async checkAllVideoLinks() {
        ...
        for (let i = 0; i < allVideos.length; i += batchSize) {
            ...
            const batchPromises = batch.map((video) =>
                this.checkSingleVideoLink(video),
            );
            ...
            try {
                ...
                batchResults.forEach((result, index) => {
                    ...
                    console.log(
                        `[${completed}/${allVideos.length}] ${video.title} - ${result.status}`,
                    );
        ...
        if (checkResults.errorVideos.length > 0) {
            ...
            checkResults.errorVideos.forEach((video, index) => {
                console.log(
                    `${index + 1}. ${video.title} - ${video.checkResult.error}`,
                );
            });
        }
...
${
    checkResults.unavailableVideos.length === 0
        ? "None! All videos are working properly."
        : checkResults.unavailableVideos
              .map(
                  (video, index) =>
...
${
    checkResults.errorVideos.length === 0
        ? "None! All videos were successfully checked."
        : checkResults.errorVideos
              .map(
                  (video, index) =>
                      `${index + 1}. ${video.title}
   URL: ${video.url}
...
`;
    ...
    playNextSong() {
        ...
        const unplayedSongs = this.currentGenreSongs.filter(
            (song) =>
                !this.playedSongsFromCurrentGenre.find(
                    (played) => played.title === song.title,
                ),
        );
    ...
    triggerNewMusicSelection() {
        console.log(
            "Triggering new music selection. canSwitchGenres:",
            this.canSwitchGenres,
        );

        // Only allow genre switching at proper transitions
        if (!this.canSwitchGenres) {
            console.log(
                "Cannot switch genres mid-phase. Waiting for phase transition.",
            );
            this.handleMidPhaseNoSongs();
            return;
        }
    ...
    createMusicSelectionOverlay(round) {
        ...
        const availableOptions = musicData.options.filter(
            (option, index) => !selectedIndexes.includes(index),
        );
    ...
    selectOverlayMusicGenre(round, genreIndex, availableOptions) {
        ...
        const musicData = this.musicLibrary[round];
        const originalIndex = musicData.options.findIndex(
            (option) => option.genre === selectedGenre.genre,
        );
    ...
    showMusicChangeNotification(genreName) {
        ...
        notification.className =
            "fixed top-4 left-1/2 transform -translate-x-1/2 bg-purple-600 text-white px-4 py-2 rounded-lg shadow-lg z-50";
    ...
    showSongSelectionOverlay(availableSongs) {
        ...
        const remainingText =
            this.playedSongsFromCurrentGenre.length > 0
    ...
    selectSongFromOverlay(selectedSong) {
        ...
        console.log(
            "Current phase data before adding:",
            this.currentPhaseData.songsPlayed,
        );

        // Check if this song was already selected (prevent double processing)
        const alreadyPlayed = this.playedSongsFromCurrentGenre.find(
        ...
        console.log(
            `Adding song to music phase: ${musicPhase} (currentMusicRound: ${this.currentMusicRound}, currentPhase: ${this.currentPhase})`,
        );
        ...
        console.log(
            `🎵 Song marked as ${this.isManualSelection ? "USER-SELECTED" : "AUTO-SELECTED"}:`,
            selectedSong.title,
        );
        ...
        if (selectedSong.youtube) {
            ...
            this.showMusicChangeNotification(
                `Playing: ${selectedSong.title} (No YouTube link available)`,
            );
        }
        ...
        if (this.playedSongsFromCurrentGenre.length === 1) {
            ...
            console.log(
                "Creating display for opening round:",
                this.currentMusicRound === 0,
            );
        ...
        const isPhaseCompleteVisible =
            phaseCompleteScreen && !phaseCompleteScreen.classList.contains("hidden");
        console.log(
            "Checking if should refresh phase summary. isShowingPhaseSummary:",
            this.isShowingPhaseSummary,
            "phaseCompleteVisible:",
            isPhaseCompleteVisible,
        );
    ...
    createMusicDisplay() {
        ...
        if (playerContainer) {
            const currentSong =
                this.currentSong ||
                this.playedSongsFromCurrentGenre[
                    this.playedSongsFromCurrentGenre.length - 1
                ];
            ...
            console.log(
                "Music display created. Countdown already running with",
                this.timeRemaining,
                "seconds",
            );
            ...
            document
                .getElementById("continueMusicButton")
    ...
    showWaitingForPhaseMessage() {
        ...
        if (!musicDisplay) {
            ...
            musicDisplay.className =
                "fixed top-4 right-4 bg-black bg-opacity-75 text-white px-3 py-2 rounded-lg shadow-lg z-50 max-w-80";
    ...
    createMaxiVotingSection() {
        ...
        if (this.selectedGenreData && musicData.options) {
            const selectedGenre = musicData.options.find(
                (option) => option.genre === this.selectedGenreData.genre,
            );
        ...
        const votingCompleted =
            this.maxiVotingResults && this.maxiVotingResults[currentMusicPhase];
        ...
        return `
            <div id="maxiVotingSection">
                <div class="text-center mb-4">
                    ...
                    <h4 class="font-semibold text-gray-800">Guess Tom's Choice!</h4>
                    <p class="text-sm text-gray-600">After listening to all songs, which one do you think Tom would prefer?</p>
                </div>
                ...
                <div class="text-center">
                    <p class="text-xs text-gray-500">Click on Tom's preferred song to see his choice!</p>
                </div>
            </div>
        `;
    }
    ...
    createVotingResultsSection(maxiChoice, votingResult) {
        const userGuessedCorrect =
            votingResult.userChoice === votingResult.maxiActualChoice;
            ...
            <div id="maxiVotingResults" class="slide-up">
                <div class="text-center mb-4">
                    ...
                    <h4 class="font-semibold text-gray-800">
                        ${userGuessedCorrect ? "You Know Me So Well!" : "Tom's Real Choice"}
                    </h4>
                </div>

                <!-- Show user's guess vs Tom's actual choice -->
                <div class="space-y-3 mb-4">
                    ...
                    <div class="p-3 bg-purple-50 border-2 border-purple-200 rounded-lg">
                        <div class="text-xs text-purple-600 font-medium">Tom's Actual Choice:</div>
    ...
    checkAllSongsPlayed() {
        ...
        if (
            !this.currentPhaseData.songsPlayed ||
            !Array.isArray(this.currentPhaseData.songsPlayed)
        ) {
        ...
        console.log(
            `Songs played in phase: ${uniqueSongs.size}/${requiredSongs} required`,
            Array.from(uniqueSongs),
        );
        ...
        if (
            !wasAllSongsPlayed &&
            this.allSongsPlayedInPhase &&
            this.currentPhaseData.questions.length === 5
        ) {
    ...
    showPhaseSummary() {
        ...
        const summaryHtml = `
            <div class="bg-white rounded-xl p-6 shadow-lg max-w-2xl mx-auto">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4">
                        ...
                        <div class="space-y-3 max-h-40 overflow-y-auto">
                            ${this.currentPhaseData.questions
                                .map(
                                    (q, i) => `
                                <div class="text-sm">
                        ...
                        <div class="mt-3 p-2 rounded ${this.isVotingCompleted() ? "bg-green-100 text-green-800" : this.isEvaluationUnlocked() ? "bg-blue-100 text-blue-800" : "bg-orange-100 text-orange-800"}">
                            ${
                                this.isVotingCompleted()
                                    ...
                                    : this.isEvaluationUnlocked()
                                      ? "🗳️ Songs complete - Now vote on Tom's choice!"
                ...
                <div class="mt-4 text-center">
                    ${
                        !this.isVotingCompleted() && this.isEvaluationUnlocked()
                            ? `
                        <div class="text-sm text-gray-600 italic">
                            🗳️ Vote on Tom's choice above to unlock continue button.
                        </div>
                    `
                            : !this.isVotingCompleted()
                              ? `
        ...
        console.log(
            "Updating phase complete screen:",
            phaseScreen ? "found" : "not found",
        );
    ...
    addSongToTracking(songData, musicPhase) {
        console.log(
            `🎵 Adding song to tracking - Phase: ${musicPhase}, Song: ${songData.title}`,
        );
        ...
        const existsInMusicPhase = this.musicPhaseSummaries[
            musicPhase
        ].songsPlayed.some(
            (song) =>
                song.title?.toLowerCase()?.trim() ===
                    songData.title?.toLowerCase()?.trim() &&
    ...
    handleSkipNextSong() {
        ...
        if (this.currentGenreSongs && this.currentGenreSongs.length > 0) {
            ...
            const unplayedSongs = this.currentGenreSongs.filter(
                (song) =>
                    !this.currentPhaseData.songsPlayed.some(
                        (played) => played.title === song.title,
                    ),
            );
            ...
            if (unplayedSongs.length > 0) {
                console.log(
                    "Showing song selection overlay with",
                ...
                console.log(
                    "No unplayed songs available, returning to music selection",
                );
    ...
    isEvaluationUnlocked() {
        ...
        console.log(
            `🔓 Evaluation unlock check: allSongs=${this.allSongsPlayedInPhase}, testMode=${this.testMode} -> ${unlocked}`,
        );
        return unlocked;
    }
    ...
    isVotingCompleted() {
        ...
        console.log(
            `🗳️ Voting completed check: phase=${currentMusicPhase}, evaluation=${evaluationUnlocked}, voting=${!!votingCompleted}`,
        );
        if (this.maxiVotingResults) {
            console.log(
                `🗳️ Available voting results:`,
                Object.keys(this.maxiVotingResults),
            );
        }
    ...
    refreshVotingSection(musicPhase) {
        ...
        const musicSection = document.querySelector(
            "#phaseCompleteScreen .bg-gradient-to-r.from-purple-50.to-pink-50",
        );
        if (musicSection) {
        ...
        console.log(
            "🗳️ Voting completed - regenerating phase summary to show Continue button",
        );
        this.showPhaseSummary();
    }
    ...
    updatePhaseSummaryDisplay() {
        ...
        const musicProgressElement = document.querySelector(
            "#phaseCompleteScreen .bg-gradient-to-r.from-purple-50.to-pink-50",
        );
        if (musicProgressElement) {
            const statusDiv = musicProgressElement.querySelector(
                'div[class*="rounded"]',
            );
            if (statusDiv) {
                ...
                if (this.isVotingCompleted()) {
                    statusDiv.className =
                        "mt-3 p-2 rounded bg-green-100 text-green-800";
                    ...
                    statusDiv.className =
                        "mt-3 p-2 rounded bg-orange-100 text-orange-800";
                    statusDiv.textContent =
                        "⏳ Experience more songs to unlock evaluation";
                }
            }
            ...
            // Update songs list
            const songsListElement =
                musicProgressElement.querySelector(".text-sm.space-y-1");
            if (songsListElement) {
                songsListElement.innerHTML = this.currentPhaseData.songsPlayed
                    .map(
                        (song) => `
                    <div class="flex justify-between">
                        <span>${song.title}</span>
        ...
        if (nextButton) {
            if (this.allSongsPlayedInPhase) {
                ...
                nextButton.className =
                    "px-8 py-3 rounded-xl font-semibold transition-all duration-300 bg-gradient-to-r from-pink-500 to-purple-600 text-white hover:from-pink-600 hover:to-purple-700";
                console.log("Button enabled - all songs played");
            } else {
                nextButton.disabled = true;
                nextButton.className =
                    "px-8 py-3 rounded-xl font-semibold transition-all duration-300 bg-gray-300 text-gray-500 cursor-not-allowed";
                console.log("Button disabled - need more songs");
            }
        }

        // Update or show the helper text
        let helperText = document.querySelector(
            "#phaseCompleteScreen p.text-sm.text-gray-600",
        );
        if (!this.allSongsPlayedInPhase) {
            if (!helperText) {
    ...
    showScreen(screenId) {
        ...
        if (screenId === "musicSelectionScreen") {
            ...
            if (playerContainer) {
                ...
                playerContainer.innerHTML = "";
                console.log(
                    "🎵 Forcefully cleared music player container via showScreen",
                );
            }
            ...
            continueButtons.forEach((button) => {
                console.log(
                    "🗑️ Removing stray continue button from DOM via showScreen",
                );
                button.remove();
            });
        ...
        if (screen) {
            ...
            if (
                this.currentPhase === 3 &&
                (screenId === "phaseIntroScreen" || screenId === "questionScreen")
            ) {
    ...
    addTestControls() {
        ...
        testPanel.className =
            "fixed top-4 right-4 bg-black bg-opacity-80 text-white p-4 rounded-lg z-50 max-w-sm";
        testPanel.innerHTML = `
        ...
        // Add event listeners
        document
            .getElementById("runFullTest")
            .addEventListener("click", () => this.runFullGameTest());
        document
            .getElementById("runRealGameTest")
            .addEventListener("click", () => this.runRealGameTest());
        document
            .getElementById("testMusicPhases")
            .addEventListener("click", () => this.testAllMusicPhases());
        document
            .getElementById("testCosmicPhase")
            .addEventListener("click", () => this.testCosmicPhase());
        document
            .getElementById("jumpToPhase")
            .addEventListener("click", () => this.jumpToPhase4());
        document
            .getElementById("showTestResults")
            .addEventListener("click", () => this.showTestResults());
        document
            .getElementById("testValidation")
            .addEventListener("click", () => this.testValidationSystem());
    }
    ...
    async runFullGameTest() {
        ...
        try {
            ...
            this.logTestResult(
                "Game initialization",
                this.currentPhase === 0 && this.totalScore === 0,
            );

            // Test 2: Start game (shows Phase 1 music selection)
            this.startGame();
            this.logTestResult(
                "Game start shows Phase 1 music",
                this.currentMusicRound === 1,
            );

            // Test 3: Phase 1 music selection
            await this.simulateMusicSelection("phase1", 1);
            this.logTestResult(
                "Phase 1 music leads to Phase 1 questions",
                this.currentPhase === 0,
            );
            ...
            this.logTestResult(
                "Phase 2 music leads to Phase 2 questions",
                this.currentPhase === 1,
            );
            ...
            this.logTestResult(
                "Phase 3 music leads to Phase 3 questions",
                this.currentPhase === 2,
            );
            ...
            this.logTestResult(
                "Phase 4 music leads to Phase 4 questions",
                this.currentPhase === 3,
            );
            ...
            this.logTestResult(
                "Phase 5 music leads to Phase 5 questions",
                this.currentPhase === 4,
            );
            ...
            this.logTestResult(
                "Simple completion shown",
                document.getElementById("restartJourney") !== null,
            );
    ...
    async runRealGameTest() {
        ...
        try {
            ...
            this.logTestResult(
                "Complete playlist generated",
                totalSongs.length >= 5,
                `${totalSongs.length} songs selected`,
            );
            ...
            this.logTestResult(
                ...
                Object.keys(songsByPhase).length >= 5,
                `Phases: ${Object.keys(songsByPhase).join(", ")}`,
            );
    ...
    async simulateRealMusicSelection(round, expectedMusicRound, genreIndex = 0) {
        ...
        if (genreIndex >= musicData.options.length) {
            ...
            console.warn(
                `Genre index ${genreIndex} out of bounds for ${round}, using index 0`,
            );
        }
        ...
        console.log(
            `Test: Setting currentMusicRound to ${this.currentMusicRound} for ${round}`,
        );
    ...
    async simulateRealPhaseCompletion(phaseIndex) {
        this.updateTestStatus(
            `Completing Phase ${phaseIndex + 1} with real answers...`,
        );
    ...
    async simulateActualSongSelection() {
        ...
        const songOptions = document.querySelectorAll(
            ".song-option-overlay, .song-option",
        );
    ...
    getCurrentPhaseSongCount() {
        return this.currentPhaseData.songsPlayed
            ? this.currentPhaseData.songsPlayed.length
            : 0;
    }
    ...
    getSongsByPhase() {
        ...
        Object.entries(this.musicPhaseSummaries).forEach(([musicPhase, summary]) => {
            const phaseName =
                summary.phaseName || this.getMusicPhaseDisplayName(musicPhase);
    ...
    async testAllMusicPhases() {
        ...
        for (const phase of musicPhases) {
            try {
                ...
                const hasOptions =
                    musicData && musicData.options && musicData.options.length > 0;
                const hasResponse = musicData && musicData.maxiResponse;

                this.logTestResult(
                    `Music phase ${phase} structure`,
                    hasOptions && hasResponse,
                );
    ...
    async testCosmicPhase() {
        ...
        try {
            ...
            setTimeout(() => {
                const hasCosmicBg =
                    gameContainer.classList.contains("cosmic-background");
                this.logTestResult("Cosmic background styling", hasCosmicBg);

                // Test Phase 4 questions structure
                const phase4 = this.phases[3];
                const hasCosmicQuestions =
                    phase4 && phase4.title === "COSMIC CONNECTION";
                const hasZodiacElements =
                    phase4 &&
                    phase4.questions &&
                    phase4.questions.some(
                        (q) =>
                            q.text &&
                            (q.text.includes("♓") ||
                                q.text.includes("♊") ||
                ...
                console.log("🧪 Phase 4 debug:", {
                    ...
                    zodiacInText: phase4?.questions?.some(
                        (q) => q.text?.includes("♓") || q.text?.includes("♊"),
                    ),
                    zodiacInOptions: phase4?.questions?.some((q) =>
                        q.options?.some(
                            (opt) =>
                ...
                this.logTestResult(
                    "Phase 4 cosmic questions",
                    hasCosmicQuestions && hasZodiacElements,
                );

                // Test cosmic music library
                const cosmicMusic = this.musicLibrary.phase4;
                const hasCelestialVibes =
                    cosmicMusic && cosmicMusic.title === "Celestial Vibes";
    ...
    async simulatePhaseCompletion(phaseIndex) {
        ...
        if (phaseIndex < 4) {
            // Don't call nextPhase for the final phase
            console.log(
                `🧪 Simulating nextPhase() call after Phase ${phaseIndex + 1} completion`,
            );
    ...
    mockNextPhase(completedPhaseIndex) {
        ...
        if (completedPhaseIndex === 0) {
            ...
            this.currentMusicRound = 2;
            console.log(
                `🧪 Phase 1 complete -> Setting up Phase 2 music (round ${this.currentMusicRound})`,
            );
        } else if (completedPhaseIndex === 1) {
            // Phase 2 complete -> Phase 3 music
            this.currentMusicRound = 3;
            console.log(
                `🧪 Phase 2 complete -> Setting up Phase 3 music (round ${this.currentMusicRound})`,
            );
        } else if (completedPhaseIndex === 2) {
            // Phase 3 complete -> Phase 4 music
            this.currentMusicRound = 4;
            console.log(
                `🧪 Phase 3 complete -> Setting up Phase 4 music (round ${this.currentMusicRound})`,
            );
        } else if (completedPhaseIndex === 3) {
            // Phase 4 complete -> Phase 5 music
            this.currentMusicRound = 5;
            console.log(
                `🧪 Phase 4 complete -> Setting up Phase 5 music (round ${this.currentMusicRound})`,
            );
        }
    }
    ...
    async simulateMusicSelection(round, expectedMusicRound) {
        ...
        if (round === "phase5") {
            ...
            this.logTestResult(`Music selection ${round}`, songsAdded);
        }
    }
    ...
    mockContinueAfterMusic() {
        ...
        if (this.currentMusicRound >= 1 && this.currentMusicRound <= 5) {
            this.currentPhase = targetPhase;
            console.log(
                `🧪 Mock transition: music round ${this.currentMusicRound} -> phase ${targetPhase}`,
            );
            ...
            console.error(
                "🧪 Unexpected currentMusicRound in mock:",
                this.currentMusicRound,
            );
        }
    }
        ...
        modal.innerHTML = `
            <div class="bg-white rounded-xl p-6 max-w-md mx-4 slide-up">
                <div class="text-center mb-4">
                    ...
                    <h3 class="text-xl font-bold">Create YouTube Playlist</h3>
    ...
    getAllSelectedSongs() {
        ...
        console.log(
            "Music phase summaries:",
            Object.keys(this.musicPhaseSummaries).length,
        );

        // Collect from music phase summaries instead of regular phase summaries
        Object.entries(this.musicPhaseSummaries).forEach(([musicPhase, summary]) => {
            console.log(
                `Processing music phase: ${musicPhase} (${summary.phaseName})`,
                "Songs:",
                summary.songsPlayed?.length || 0,
            );
            if (summary.songsPlayed) {
                summary.songsPlayed.forEach((song) => {
                    ...
                    if (song.userSelected === true && !processedSongs.has(songKey)) {
                        console.log(
                            `Adding USER-SELECTED song from ${summary.phaseName}:`,
                            song.title,
                            "YouTube ID:",
                            song.youtubeId,
                        );
                        ...
                        console.log(
                            "Skipping NON-USER-SELECTED song:",
                            song.title,
                            "userSelected:",
                            song.userSelected,
                        );
...
Perfect soundtrack for our journey together! 💕`;
    ...
    openYouTubePlaylist(songs) {
        ...
        if (playlistUrl) {
            ...
            this.showSuccessMessage(
                `YouTube playlist created with ${songsWithIds.length} songs! 🎵`,
            );
        } else {
    ...
    createYouTubeSearchPlaylist(songs) {
        ...
        this.showSuccessMessage(
            `Created YouTube search for all ${songs.length} songs! You can manually add them to a playlist.`,
        );
    }
        ...
        for (const round of allGenres) {
            for (const option of round.options) {
                ...
                if (option.myChoice && option.myChoice.title === songTitle) {
                    console.log(
                        "Found match in myChoice! YouTube ID:",
                        option.myChoice.youtube,
                    );
    ...
    async testValidationSystem() {
        ...
        try {
            ...
            this.logTestResult(
                "Validation prevents bypass without songs",
                validationWorked,
            );
            ...
            if (playerContainer) {
                playerContainer.classList.add("hidden");
                playerContainer.innerHTML =
                    '<button id="continueMusicButton">Continue Journey</button>';
            }
            ...
            this.testMode = true;
            this.currentPhaseData.songsPlayed = [
                { title: "Test Song", userSelected: true },
            ];
            ...
            this.logTestResult(
                "Test mode reduces song requirements",
            ...
            if (phaseData.options) {
                phaseData.options.forEach((genre, genreIndex) => {
                    ...
                    if (genre.songs) {
                        genre.songs.forEach((song, songIndex) => {
                            ...
                            if (duplicateIds.has(song.youtube)) {
                                console.warn(
                                    `⚠️ Duplicate YouTube ID found: ${song.youtube} for "${song.title}"`,
                                );
                            } else {
                            ...
                            console.log(
                                `    ${songIndex + 1}. ${song.title} (${song.year}) - ${song.youtube}`,
                            );
                        });
                    }
                    ...
                    if (genre.myChoice) {
                        ...
                        if (duplicateIds.has(song.youtube)) {
                            console.warn(
                                `⚠️ Duplicate YouTube ID found: ${song.youtube} for "${song.title}" (myChoice)`,
                            );
                        } else {
                            duplicateIds.add(song.youtube);
                        }
                        ...
                        console.log(
                            `    💝 myChoice: ${song.title} (${song.year}) - ${song.youtube}`,
                        );
                        if (song.message) {
    ...
    analyzeVideoMismatches() {
        ...
        allVideos.forEach((video) => {
            ...
            const hasHiphopKeywords = hiphopKeywords.some((keyword) =>
                titleLower.includes(keyword),
            );
            ...
            const hasRockKeywords = rockKeywords.some((keyword) =>
                titleLower.includes(keyword),
            );
            ...
            const hasJazzKeywords = jazzKeywords.some((keyword) =>
                titleLower.includes(keyword),
            );

            // Check for mismatches
            if (
                hasClassicalKeywords &&
                !genreLower.includes("classical") &&
                !genreLower.includes("orchestral")
            ) {
            ...
            if (
                ...
                (genreLower.includes("electronic") ||
                    genreLower.includes("metal") ||
                    genreLower.includes("punk"))
            ) {
                analysisReport.genreMismatches.push({
                    ...video,
        ...
        if (analysisReport.duplicateIds.length > 0) {
            analysisReport.recommendations.push(
                "🔄 Review duplicate YouTube IDs - same video used multiple times may confuse users",
            );
        }
        if (analysisReport.shortIds.length > 0) {
            analysisReport.recommendations.push(
                "⚠️ Fix invalid YouTube IDs (must be exactly 11 characters)",
            );
        }
        if (analysisReport.genericTitles.length > 0) {
            analysisReport.recommendations.push(
                "📝 Replace generic titles with actual song names and artists",
            );
        }
        if (analysisReport.genreMismatches.length > 0) {
            analysisReport.recommendations.push(
                "🎵 Review genre-title mismatches - content may not match expected genre",
            );
        }
        ...
        console.log("📊 SUMMARY:", {
            ...
            totalIssues:
                analysisReport.suspiciousVideos.length +
                analysisReport.duplicateIds.length,
        ...
        if (analysisReport.suspiciousVideos.length > 0) {
            ...
            analysisReport.suspiciousVideos.forEach((video, index) => {
                console.log(
                    `${index + 1}. [${video.severity.toUpperCase()}] ${video.phase} > ${video.genre} > ${video.title}`,
                );
        ...
        if (analysisReport.duplicateIds.length > 0) {
            ...
            analysisReport.duplicateIds.forEach((dup, index) => {
                console.log(
                    `${index + 1}. ID: ${dup.youtubeId} (used ${dup.count} times)`,
                );
...
`;
        ...
        console.log(
            "📄 Comprehensive mismatch analysis report downloaded successfully!",
        );
