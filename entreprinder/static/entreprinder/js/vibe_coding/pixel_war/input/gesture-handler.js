...
class GestureHandler extends EventTarget {
    ...
    calculateBounds() {
        ...
        console.log("📐 calculateBounds debug:", {
            ...
            viewportLargerThanGrid:
                viewportWidth >= gridWidth && viewportHeight >= gridHeight,
        });
    ...
    handleDrag({
        ...
        if (first) {
            console.log("🖐️ Drag started from:", {
    ...
    startMomentumAnimation(velocityX, velocityY) {
        ...
        const animate = () => {
            ...
            if (
                Math.abs(this.animation.velocityX) > threshold ||
                Math.abs(this.animation.velocityY) > threshold
            ) {
