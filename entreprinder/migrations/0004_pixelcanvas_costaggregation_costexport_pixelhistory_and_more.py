    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "anonymous_cooldown_seconds",
                    models.IntegerField(
                        default=30, help_text="Cooldown for anonymous users (seconds)"
                    ),
                ),
                (
                    "registered_cooldown_seconds",
                    models.IntegerField(
                        default=12, help_text="Cooldown for registered users (seconds)"
                    ),
                ),
                (
                    "registered_pixels_per_minute",
                    models.IntegerField(
                        default=5,
                        help_text="Max pixels per minute for registered users",
                    ),
                ),
                (
                    "anonymous_pixels_per_minute",
                    models.IntegerField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="finops_hub__aggrega_5d9e9e_idx",
                    ),
                    models.Index(
                        fields=["dimension_type", "dimension_value", "period_start"],
                        name="finops_hub__dimensi_8db775_idx",
                    ),
                ],
                "unique_together": {
                    (
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["subscription_name", "billing_period_start"],
                        name="finops_hub__subscri_0dbb11_idx",
                    ),
                    models.Index(
                        fields=["import_status", "import_completed_at"],
                        name="finops_hub__import__9d31f3_idx",
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "provider_name",
                    models.CharField(default="Microsoft", max_length=100),
                ),
                (
                    "region_id",
                    models.CharField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["billing_period_start", "sub_account_name"],
                        name="finops_hub__billing_8853b3_idx",
                    ),
                    models.Index(
                        fields=["service_name", "billing_period_start"],
                        name="finops_hub__service_809822_idx",
                    ),
                    models.Index(
                        fields=["resource_group_name", "billing_period_start"],
                        name="finops_hub__resourc_1be05a_idx",
                    ),
                    models.Index(
                        fields=["charge_period_start", "billed_cost"],
                        name="finops_hub__charge__23fb00_idx",
                    ),
                    models.Index(
                        fields=["resource_name", "service_name"],
                        name="finops_hub__resourc_3481d2_idx",
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["liker", "liked"], name="matching_li_liker_i_5a549e_idx"
                    )
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["canvas", "last_placed"],
                        name="vibe_coding_canvas__742cb8_idx",
                    )
                ],
                "constraints": [
