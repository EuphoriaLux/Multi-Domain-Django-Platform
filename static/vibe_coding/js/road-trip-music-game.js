            ...
            phase4: {
                ...
                options: [
                    ...
                    },
                    {
                        ...
                        songs: [
                            { title: "River - Bishop Briggs", youtube: "h5jz8xdpR0M", year: "2016" },
                            { title: "Ribs - Lorde", youtube: "4qaeoz_7cyE", year: "2013" },
                            { title: "Where Is My Mind - Pixies", youtube: "OJ62RzJkYUo", year: "1988" }
                        ],
    ...
    setupEventListeners() {
        ...
        document.getElementById('nextPhaseButton')?.addEventListener('click', () => {
            ...
            if (this.isVotingCompleted()) {
                ...
                alert('Please complete the music evaluation by voting on Tom\'s choice first.');
            }
        });
        ...
        if (musicProgressElement) {
            ...
            if (statusDiv) {
                ...
                if (this.isVotingCompleted()) {
                    ...
                    statusDiv.textContent = '🗳️ Songs complete - Now vote on Tom\'s choice!';
                } else {
