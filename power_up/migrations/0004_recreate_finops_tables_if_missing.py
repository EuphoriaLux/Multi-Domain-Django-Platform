# Migration to recreate finops tables if they were accidentally dropped
# This handles the production case where 0003 dropped tables before finops migrations ran

from django.db import migrations


def recreate_finops_tables_if_missing(apps, schema_editor):
    """
    Recreate finops tables if they don't exist.
    Reuses the same logic from 0002_ensure_finops_tables_exist.
    """
...
class Migration(migrations.Migration):
    """
    Recreate finops tables if they were dropped by 0003 before finops app migrations ran.

    This is a safety net for production where 0003 may have dropped the tables
    before the finops app was able to take ownership via its own migrations.
    """

    dependencies = [
        ('power_up', '0003_delete_costaggregation_remove_costrecord_cost_export_and_more'),
    ]

    operations = [
        migrations.RunPython(recreate_finops_tables_if_missing, no_op),
    ]
