    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "pricing_source",
                    models.CharField(default="Azure Retail Prices API", max_length=50),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["reservation_id", "is_estimate"],
                        name="finops_hub__reserva_c5dfc3_idx",
                    ),
                    models.Index(
                        fields=["service_name", "region"],
                        name="finops_hub__service_2bf5ce_idx",
                    ),
                    models.Index(
                        fields=["purchase_date", "expiry_date"],
                        name="finops_hub__purchas_274088_idx",
                    ),
                ],
            },
        ),
