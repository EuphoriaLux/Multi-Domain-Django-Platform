...
class CostRecordAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ("Region", {"fields": ["region_id", "region_name"]}),
        (
            "SKU Details",
            {
                "fields": [
...
class CostAggregationAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        (
            "Top Items",
            {"fields": ["top_services", "top_resources"], "classes": ["collapse"]},
        ),
...
class CostAnomalyAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ("Affected Resource", {"fields": ["dimension_type", "dimension_value"]}),
        (
            "Cost Analysis",
            {
                "fields": [
...
class CostForecastAdmin(admin.ModelAdmin):
    ...
    def confidence_interval(self, obj):
        ...
        return format_html("€{:.2f} - €{:.2f}", obj.lower_bound, obj.upper_bound)
...
class ReservationCostAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ("SKU Details", {"fields": ["sku_name", "sku_description"]}),
        (
            "Term & Dates",
