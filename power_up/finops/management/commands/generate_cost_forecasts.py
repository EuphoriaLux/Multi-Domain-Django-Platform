...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--currency", type=str, default="EUR", help="Currency code (default: EUR)"
        )
        parser.add_argument(
            "--refresh",
            action="store_true",
