"""Classic Crush.lu quiz pack — 6 rounds x 6 questions, trilingual (EN, DE, FR).

Extracted verbatim from ``generate_crush_quiz`` when the pack registry was
introduced. Text-only: no round in this pack carries a media stimulus.
"""
