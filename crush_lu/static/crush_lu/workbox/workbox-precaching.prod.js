            ...
            constructor({ precacheController: t }) {
                ((this.cacheKeyWillBeUsed = async ({ request: t, params: e }) => {
                    const s =
                        ...
                        this.tt.getCacheKeyForURL(t.url);
                    ...
                    });
                {
                    ...
                    ((n = await e.fetch(
                        ...
                        s &&
                            r &&
                            "no-cors" !== t.mode &&
                            (this.it(), await e.cachePut(t, n.clone())));
                }
                return n;
            }
            async st(t, e) {
                ...
                for (const n of t) {
                    ...
                    if (this.ct.has(i) && this.ct.get(i) !== t)
                        throw new s.WorkboxError(
                            ...
                            { firstEntry: this.ct.get(i), secondEntry: t },
                        );
                    if ("string" != typeof n && n.integrity) {
                        if (this.ot.has(t) && this.ot.get(t) !== n.integrity)
                            throw new s.WorkboxError(
                                "add-to-cache-list-conflicting-integrities",
                                { url: i },
                            );
                        this.ot.set(t, n.integrity);
                    }
                    if ((this.ct.set(i, t), this.rt.set(i, c), e.length > 0)) {
        ...
        return (
            ...
            (t.PrecacheFallbackPlugin = class {
                constructor({ fallbackURL: t, precacheController: e }) {
                    ((this.handlerDidError = () => this.tt.matchPrecache(this.ut)),
                        (this.ut = t),
                        (this.tt = e || d()));
                }
            }),
