                    ...
                    if (t instanceof Error)
                        throw (
                            "QuotaExceededError" === t.name &&
                                (await a.executeQuotaErrorCallbacks()),
                            t
                        );
                }
                ...
                try {
                    ...
                    if (e instanceof Error)
                        for (const a of t.iterateCallbacks("handlerDidError"))
                            if (((n = await a({ error: e, event: r, request: s })), n))
                                break;
                    if (!n) throw e;
                }
        ...
        return (
            (t.CacheFirst = class extends w {
                async _handle(t, s) {
                    ...
                    if (!n)
                        throw new e.WorkboxError("no-response", {
                            url: t.url,
                            error: r,
                        });
                    return n;
            ...
            (t.NetworkFirst = class extends w {
                ...
                async _handle(t, s) {
                    ...
                    const o = await s.waitUntil(
                        (async () =>
                            (await s.waitUntil(Promise.race(n))) || (await i))(),
                    );
                ...
                async _handle(t, s) {
                    ...
                    try {
                        ...
                        if (((n = await Promise.race(e)), !n))
                            throw new Error(
                                `Timed out the network response after ${this.Ot} seconds.`,
                            );
                    } catch (t) {
                        t instanceof Error && (r = t);
                    }
