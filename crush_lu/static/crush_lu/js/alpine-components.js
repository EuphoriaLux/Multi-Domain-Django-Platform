    ...
    Alpine.data("standalonePhoneVerification", function () {
        return {
            ...
            init: function () {
                ...
                this.phoneInputId =
                    this.$el.getAttribute("data-phone-input-id") || "phone_number";
                this.nextUrl = this.$el.getAttribute("data-next-url") || "";
                var currentPhone = this.$el.getAttribute("data-current-phone") || "";
                this.whatsappNumber =
                    this.$el.getAttribute("data-whatsapp-number") || "";
                this.whatsappMessage =
                    this.$el.getAttribute("data-whatsapp-message") || "";
            ...
            sendCode: function () {
                ...
                if (this.iti && !this.iti.isValidNumber()) {
                    ...
                    this.error =
                        errorMessages[errorCode] || "Please enter a valid phone number";
                    return;
                }
            ...
            resendCode: function () {
                ...
                if (window.phoneVerification) {
                    window.phoneVerification
                        .sendVerificationCode(this.displayPhone)
                        .then(function (result) {
                            self.isLoading = false;
                            if (result.success) {
                                self.failureCount = 0;
