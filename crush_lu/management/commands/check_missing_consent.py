    ...
    def handle(self, *args, **options):
        ...
        if fix_consent and users_with_profiles:
            ...
            for consent in users_with_profiles:
                ...
                consent.crushlu_consent_date = (
                    consent.user.date_joined
                )  # Use signup date
                ...
                if fixed_count % 10 == 0:
                    self.stdout.write(
                        f"Fixed {fixed_count}/{len(users_with_profiles)}..."
                    )
        ...
        if users_with_profiles and not fix_consent:
            ...
            self.stdout.write(
                self.style.SUCCESS("  python manage.py check_missing_consent --fix\n")
            )
