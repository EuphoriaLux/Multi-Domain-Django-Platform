...
STATIONS_MINETTE = [
    {
        ...
        "lng": "5.858759",
        "unlock_mode": "gps_qr",
        "intro": "Head to Gare de Fond-de-Gras! Find the Crush Statue near the historic Train 1900 platform and scan the QR code to unlock your first challenge.",
        ...
        "answer": "",  # Accepts any choice (date icebreaker prompt)
        "alternatives": [],
    ...
    },
    {
        ...
        "challenge_type": "open_text",
        "question": "Welches berühmte rote Eisenerz wurde hier im Fond-de-Gras gefördert?",
        "answer": "Minette",
        "alternatives": ["Iron ore", "Eisenerz", "Minette ore", "iron"],
        "hint_1": "Es gibt der Region und dem Boden seine charakteristische rote Farbe.",
        "points": 100,
    },
    {
        "order": 3,
        ...
        "challenge_type": "multiple_choice",
        "question": "Was ist die wichtigste Eigenschaft für dein perfektes Match bei der Schatzsuche?",
        "options": {
            "1": "Abenteuerlust & Orientierungssinn",
            "2": "Humor & Gelassenheit",
            "3": "Teamgeist & Hilfsbereitschaft",
        },
        "answer": "",  # Accepts any choice
        "alternatives": [],
        "hint_1": "Jeder Partner bringt seine eigenen Stärken mit!",
        "points": 100,
    },
    {
        "order": 4,
        ...
        "challenge_type": "open_text",
        "question": "Was bedeutet der luxemburgische Name 'Giele Botter' auf Deutsch oder Englisch?",
        "answer": "Gelbe Butter",
        "alternatives": ["Yellow Butter", "Butter", "Gelb Butter", "Yellow butter"],
        "hint_1": "Es ist nach dem gelben Ton/Boden benannt.",
        "points": 100,
    },
    {
        "order": 5,
        ...
        "challenge_type": "multiple_choice",
        "question": "Wo geht das perfekte erste Date nach dem Crush Cache hin?",
        "options": {
            "1": "Auf einen gemütlichen Kaffee oder Drink",
            "2": "Gemeinsam was Leckeres essen",
            "3": "Weiter spazieren und quatschen",
        },
        "answer": "",  # Accepts any choice
        "alternatives": [],
        "hint_1": "Nach dem Gewinnen schmeckt der Drink umso besser!",
        "points": 100,
    },
    {
        "order": 6,
