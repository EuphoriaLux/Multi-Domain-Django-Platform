    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if request.method == "POST":
            ...
            if not throttle.allow_request(request, self):
                wait = throttle.wait()
                logger.warning(
                    f"[RATE-LIMIT] Login rate limit exceeded for IP: {throttle.get_ident(request)}"
                )
                return HttpResponse(
        ...
        try:
            ...
            logger.error(
                f"[LOGIN-DEBUG] Exception in dispatch: {type(e).__name__}: {e}"
            )
            raise
...
urlpatterns = [
    ...
    path(
        "media/profile/<int:user_id>/<str:photo_field>/",
    ...
    path(
        "data-deletion/status/", views.data_deletion_status, name="data_deletion_status"
    ),
    # Facebook Data Deletion Callback (required by Facebook)
    path(
        "facebook/data-deletion/",
        views.facebook_data_deletion_callback,
    ...
    path(
        ...
        views_oauth_popup.oauth_popup_callback,
        name="oauth_popup_callback",
    ),
    path(
        "oauth/popup-error/",
        views_oauth_popup.oauth_popup_error,
        name="oauth_popup_error",
    ),
    ...
    path(
        "mockup/meeting-luxid/",
        views.luxid_meeting_guide_view,
        name="luxid_meeting_guide",
    ),
    ...
    path(
        "verify-phone/", views_phone_verification.verify_phone_page, name="verify_phone"
    ),
    # User dashboard
    ...
    path(
        "profile/",
        RedirectView.as_view(pattern_name="crush_lu:dashboard"),
        name="profile",
    ),
    ...
    path(
        "account/disconnect/<int:social_account_id>/",
        views.disconnect_social_account,
        name="disconnect_social_account",
    ),
    path(
        "account/link-apple/", views.apple_relay_link_prompt, name="apple_link_prompt"
    ),
    # GDPR & Account Deletion
    path(
        "account/delete/", views.delete_account, name="delete_account"
    ),  # Redirects to GDPR dashboard
    path(
        "account/delete-profile/",
        views.delete_crushlu_profile_view,
        name="delete_crushlu_profile",
    ),  # Default action
    path(
        "account/gdpr/", views.gdpr_data_management, name="gdpr_data_management"
    ),  # Full GDPR options
    path(
        "account/gdpr/export/", views.export_user_data, name="export_user_data"
    ),  # GDPR data export
    path(
        "consent/confirm/", views.consent_confirm, name="consent_confirm"
    ),  # Retroactive consent confirmation
    path(
        "account/banned/", views.account_banned, name="account_banned"
    ),  # Banned user info page
    # Email unsubscribe (public access with token)
    path(
        "unsubscribe/<uuid:token>/", views.email_unsubscribe, name="email_unsubscribe"
    ),
    ...
    path(
        "invite/<uuid:code>/accept/", views.invitation_accept, name="invitation_accept"
    ),
    # Events
    ...
    path(
        ...
        views.event_calendar_download,
        name="event_calendar_download",
    ),
    path(
        "events/<int:event_id>/ticket/", views_ticket.event_ticket, name="event_ticket"
    ),
    # Event Activity Voting (Phase 1)
    path(
        "events/<int:event_id>/voting/lobby/",
        views.event_voting_lobby,
        name="event_voting_lobby",
    ),
    path(
        "events/<int:event_id>/voting/",
        views.event_activity_vote,
        name="event_activity_vote",
    ),
    path(
        "events/<int:event_id>/voting/results/",
        views.event_voting_results,
        name="event_voting_results",
    ),
    # Presentations (Phase 2)
    path(
        "events/<int:event_id>/presentations/",
        views.event_presentations,
        name="event_presentations",
    ),
    path(
        "events/<int:event_id>/presentations/rate/<int:presenter_id>/",
        views.submit_presentation_rating,
        name="submit_presentation_rating",
    ),
    path(
        "events/<int:event_id>/presentations/my-scores/",
        views.my_presentation_scores,
        name="my_presentation_scores",
    ),
    # Note: Presentations API moved to urls_crush.py (language-neutral) for JS polling calls
    # Coach Presentation Controls
    path(
        "coach/events/<int:event_id>/presentations/control/",
        views.coach_presentation_control,
        name="coach_presentation_control",
    ),
    path(
        "coach/events/<int:event_id>/presentations/advance/",
        views.coach_advance_presentation,
        name="coach_advance_presentation",
    ),
    # Live Quiz (WebSocket-based)
    path("events/<int:event_id>/quiz/", views_quiz.quiz_live_view, name="quiz_live"),
    path(
        "events/<int:event_id>/quiz/coach/",
        views_quiz.quiz_coach_view,
        name="quiz_coach",
    ),
    ...
    # Sender views
    path(
        "events/<int:event_id>/spark/request/",
        views_crush_spark.spark_request,
        name="spark_request",
    ),
    ...
    path(
        "sparks/<int:spark_id>/create-journey/",
        views_crush_spark.spark_create_journey,
        name="spark_create_journey",
    ),
    # Spark inline actions (HTMX)
    path(
        "events/<int:event_id>/spark/send/<int:user_id>/",
        views_crush_spark.spark_send_inline,
        name="spark_send_inline",
    ),
    path(
        "events/<int:event_id>/spark/actions/<int:user_id>/",
        views_crush_spark.spark_actions,
        name="spark_actions",
    ),
    # Recipient views
    ...
    path(
        "coach/sparks/<int:spark_id>/assign/",
        views_crush_spark.coach_spark_assign,
        name="coach_spark_assign",
    ),
    ...
    path(
        "coach/review/<int:submission_id>/",
        views.coach_review_profile,
        name="coach_review_profile",
    ),
    path(
        "coach/review/<int:submission_id>/preview/",
        views.coach_preview_email,
        name="coach_preview_email",
    ),
    path(
        "coach/review/<int:submission_id>/call-complete/",
        views.coach_mark_review_call_complete,
        name="coach_mark_review_call_complete",
    ),
    path(
        "coach/review/<int:submission_id>/call-attempt/",
        views.coach_log_failed_call,
        name="coach_log_failed_call",
    ),
    path(
        "coach/review/<int:submission_id>/sms-sent/",
        views.coach_log_sms_sent,
        name="coach_log_sms_sent",
    ),
    path("coach/sessions/", views.coach_sessions, name="coach_sessions"),
    path(
        "coach/verifications/",
        views.coach_verification_history,
        name="coach_verification_history",
    ),
    path("coach/team-stats/", views.coach_team_stats, name="coach_team_stats"),
    # Coach invitation management
    path(
        "coach/event/<int:event_id>/invitations/",
        views.coach_manage_invitations,
        name="coach_manage_invitations",
    ),
    ...
    path(
        "coach/events/<int:event_id>/",
        views.coach_event_detail,
        name="coach_event_detail",
    ),
    path(
        "coach/events/<int:event_id>/checkin/",
        views_coach_module.coach_event_checkin,
        name="coach_event_checkin",
    ),
    path(
        "coach/events/<int:event_id>/sms-invite/",
        views_coach_module.coach_event_sms_invite,
        name="coach_event_sms_invite",
    ),
    path(
        "coach/events/<int:event_id>/sms-invite/<int:submission_id>/log/",
        views_coach_module.coach_log_event_sms_sent,
        name="coach_log_event_sms_sent",
    ),
    path(
        "coach/events/<int:event_id>/sms-invite/profile/<int:profile_id>/log/",
        views_coach_module.coach_log_event_sms_sent_by_profile,
        name="coach_log_event_sms_sent_by_profile",
    ),
    # Coach connection management
    path("coach/connections/", views.coach_connections, name="coach_connections"),
    path(
        "coach/connections/<int:connection_id>/",
        views.coach_connection_review,
        name="coach_connection_review",
    ),
    # Coach member overview & assignment
    path(
        "coach/member/<int:user_id>/",
        views.coach_member_overview,
        name="coach_member_overview",
    ),
    path(
        "coach/member/<int:user_id>/matches/",
        views.coach_member_matches,
        name="coach_member_matches",
    ),
    path("coach/match-pairs/", views.coach_match_pairs, name="coach_match_pairs"),
    path(
        "coach/submission/<int:submission_id>/reassign/",
        views.coach_reassign_submission,
        name="coach_reassign_submission",
    ),
    # Coach journey management
    path(
        "coach/journeys/", views.coach_journey_dashboard, name="coach_journey_dashboard"
    ),
    path(
        "coach/journeys/<int:journey_id>/edit/",
        views.coach_edit_journey,
        name="coach_edit_journey",
    ),
    path(
        "coach/journeys/challenge/<int:challenge_id>/edit/",
        views.coach_edit_challenge,
        name="coach_edit_challenge",
    ),
    path(
        "coach/journeys/progress/<int:progress_id>/",
        views.coach_view_user_progress,
        name="coach_view_user_progress",
    ),
    ...
    path(
        "events/<int:event_id>/connect/<int:user_id>/",
        views.request_connection,
        name="request_connection",
    ),
    path(
        "events/<int:event_id>/connect-inline/<int:user_id>/",
        views.request_connection_inline,
        name="request_connection_inline",
    ),
    path(
        "events/<int:event_id>/connection-actions/<int:user_id>/",
        views.connection_actions,
        name="connection_actions",
    ),
    path("connections/", views.my_connections, name="my_connections"),
    path(
        "connections/<int:connection_id>/",
        views.connection_detail,
    ...
    # Journey Views
    path(
        "journey/", views_journey.journey_map, name="journey_map"
    ),  # Backwards compatible - redirects to selector
    path("journey/select/", views_journey.journey_selector, name="journey_selector"),
    path(
        "journey/wonderland/",
        views_journey.journey_map_wonderland,
        name="journey_map_wonderland",
    ),
    path(
        "journey/chapter/<int:chapter_number>/",
        views_journey.chapter_view,
        name="chapter_view",
    ),
    path(
        "journey/chapter/<int:chapter_number>/challenge/<int:challenge_id>/",
        views_journey.challenge_view,
        name="challenge_view",
    ),
    path(
        "journey/reward/<int:reward_id>/", views_journey.reward_view, name="reward_view"
    ),
    path(
        "journey/certificate/", views_journey.certificate_view, name="certificate_view"
    ),
    # Journey Gift System
    path("journey/gift/create/", views_journey_gift.gift_create, name="gift_create"),
    path(
        "journey/gift/success/<str:gift_code>/",
        views_journey_gift.gift_success,
        name="gift_success",
    ),
    path(
        "journey/gift/<str:gift_code>/",
        views_journey_gift.gift_landing,
        name="gift_landing",
    ),
    path(
        "journey/gift/<str:gift_code>/claim/",
        views_journey_gift.gift_claim,
        name="gift_claim",
    ),
    ...
    path(
        "api/journey/submit-challenge/",
        api_journey.submit_challenge,
        name="api_submit_challenge",
    ),
    ...
    path(
        "api/journey/final-response/",
        api_journey.record_final_response,
        name="api_record_final_response",
    ),
    ...
    path(
        "advent/door/<int:door_number>/",
        views_advent.advent_door_view,
        name="advent_door",
    ),
    path("advent/qr/<uuid:token>/", views_advent.scan_qr_code, name="advent_scan_qr"),
    path(
        "advent/qr-scanner/", views_advent.advent_qr_scanner, name="advent_qr_scanner"
    ),
    # Advent Calendar API Endpoints
    path(
        "api/advent/status/", views_advent.get_advent_status, name="api_advent_status"
    ),
    path(
        "api/advent/open-door/", views_advent.open_door_api, name="api_advent_open_door"
    ),
]
