    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_seen",
                    models.DateTimeField(help_text="Last time user made a request"),
                ),
                (
                    "last_pwa_visit",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0, help_text="Total number of visits/requests"
                    ),
                ),
                (
                    "first_seen",
                    models.DateTimeField(
                        auto_now_add=True, help_text="First time user was tracked"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "p256dh_key",
                    models.CharField(
                        help_text="Public key for encryption (p256dh)", max_length=255
                    ),
                ),
                (
                    "auth_key",
                    models.CharField(
                        help_text="Authentication secret (auth)", max_length=255
                    ),
                ),
                (
                    "user_agent",
