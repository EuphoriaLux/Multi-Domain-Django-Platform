            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        help_text="Order in queue (1, 2, 3...)"
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="presentation_queue",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="presentation_ratings",
                        to="crush_lu.meetupevent",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="presentations_received",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="presentations_given",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "round_number",
                    models.PositiveIntegerField(
                        help_text="Which speed dating round (1, 2, 3...)"
                    ),
                ),
                (
                    "mutual_rating_score",
                    models.FloatField(
                        default=0, help_text="Combined rating score from Phase 2"
                    ),
                ),
                (
                    "is_top_match",
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="speed_dating_pairs",
                        to="crush_lu.meetupevent",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="speed_dating_as_user1",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="speed_dating_as_user2",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
