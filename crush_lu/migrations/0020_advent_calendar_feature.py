    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_date",
                    models.DateField(help_text="Start date (usually December 1)"),
                ),
                (
                    "end_date",
                    models.DateField(help_text="End date (usually December 24)"),
                ),
                (
                    "allow_catch_up",
                    models.BooleanField(
                ...
                (
                    ...
                    models.TextField(
                        blank=True, help_text="Description shown on the calendar page"
                    ),
                ),
                (
                    "background_image",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "door_number",
                    models.PositiveIntegerField(help_text="Door number (1-24)"),
                ),
                (
                    "content_type",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Title shown when door is opened", max_length=200
                    ),
                ),
                (
                    "message",
                ...
                (
                    "bonus_content",
                    models.TextField(
                        blank=True, help_text="Bonus text content unlocked via QR code"
                    ),
                ),
                (
                    "bonus_photo",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_door_opened",
                    models.PositiveIntegerField(
                        blank=True, help_text="Last door number opened", null=True
                    ),
                ),
                (
                    "last_opened_at",
                    models.DateTimeField(
                        blank=True, help_text="When the last door was opened", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_used",
                    models.BooleanField(
                        default=False, help_text="Has this token been redeemed?"
                    ),
                ),
                (
                    "used_at",
                    models.DateTimeField(
                        blank=True, help_text="When the token was redeemed", null=True
                    ),
                ),
                (
                    "expires_at",
