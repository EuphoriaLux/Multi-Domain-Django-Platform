    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "challenge_order",
                    models.IntegerField(help_text="Order within chapter (1, 2, 3...)"),
                ),
                (
                    "challenge_type",
                    models.CharField(
                ...
                (
                    "question",
                    models.TextField(help_text="The question/prompt/instructions"),
                ),
                (
                    "options",
                    models.JSONField(
                ...
                (
                    "hint_1_cost",
                    models.IntegerField(
                        default=20, help_text="Points deducted for hint 1"
                    ),
                ),
                ...
                (
                    "hint_2_cost",
                    models.IntegerField(
                        default=50, help_text="Points deducted for hint 2"
                    ),
                ),
                ...
                (
                    "hint_3_cost",
                    models.IntegerField(
                        default=80, help_text="Points deducted for hint 3"
                    ),
                ),
                (
                    "points_awarded",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text='e.g., "Down the Rabbit Hole"', max_length=200
                    ),
                ),
                (
                    "theme",
                    models.CharField(
                        help_text='e.g., "Mystery & Curiosity"', max_length=100
                    ),
                ),
                (
                    "story_introduction",
                ...
                (
                    "estimated_duration",
                    models.IntegerField(
                        default=10, help_text="Estimated minutes to complete"
                    ),
                ),
                (
                    "difficulty",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True, help_text="Must complete previous chapter first"
                    ),
                ),
                (
                    "completion_message",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hints_used",
                    models.JSONField(
                        default=list, help_text="List of hint numbers used [1, 2, 3]"
                    ),
                ),
                ("points_earned", models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_chapters",
                    models.IntegerField(
                        default=6, help_text="Total number of chapters in this journey"
                    ),
                ),
                (
                    "estimated_duration_minutes",
                    models.IntegerField(
                        default=90, help_text="Estimated total time to complete"
                    ),
                ),
                (
                    "date_first_met",
                ...
                (
                    "location_first_met",
                    models.CharField(
                        blank=True, help_text="Where you first met", max_length=200
                    ),
                ),
                (
                    "certificate_enabled",
                    models.BooleanField(
                        default=True, help_text="Generate completion certificate"
                    ),
                ),
                (
                    "final_message",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_time_seconds",
                    models.IntegerField(
                        default=0, help_text="Total time spent in journey"
                    ),
                ),
                ("is_completed", models.BooleanField(default=False)),
                ("completed_at", models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "photo",
                    models.ImageField(
                        blank=True, null=True, upload_to="journey_rewards/"
                    ),
                ),
                (
                    "audio_file",
                    models.FileField(
                        blank=True, null=True, upload_to="journey_rewards/audio/"
                    ),
                ),
                (
                    "video_file",
                    models.FileField(
                        blank=True, null=True, upload_to="journey_rewards/video/"
                    ),
                ),
                (
                    "puzzle_pieces",
