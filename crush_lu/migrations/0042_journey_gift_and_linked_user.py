    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gift_code",
                    models.CharField(
                        default=crush_lu.models.journey_gift.generate_gift_code,
                        help_text="Unique gift code (e.g., WOY-A1B2C3D4)",
                        max_length=16,
                        unique=True,
                    ),
                ),
                (
                    "sender_message",
                    models.TextField(
                        blank=True, help_text="Optional personal message from sender"
                    ),
                ),
                (
                    "recipient_name",
                    models.CharField(
                        help_text="Name/nickname for the journey story (e.g., 'My Crush', 'Marie')",
                        max_length=100,
                    ),
                ),
                (
                ...
                (
                    "date_first_met",
                    models.DateField(
                        help_text="Date the sender and recipient first met"
                    ),
                ),
                (
                    "location_first_met",
                    models.CharField(
                        help_text="Location where they first met", max_length=200
                    ),
                ),
                (
                    "status",
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="Optional expiration date for the gift",
                        null=True,
                    ),
                ),
                (
                    "claimed_at",
                    models.DateTimeField(
                        blank=True, help_text="When the gift was claimed", null=True
                    ),
                ),
                (
                    "qr_code_image",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Direct link to user (bypasses name matching). Used for gifted journeys.",
                null=True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="User who claimed this gift",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Journey created from this gift",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            ...
            name="sender",
            field=models.ForeignKey(
                help_text="User who created this gift",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text="Special experience created from this gift",
                null=True,
                on_delete=django.db.models.deletion.SET_NULL,
                related_name="source_gift",
