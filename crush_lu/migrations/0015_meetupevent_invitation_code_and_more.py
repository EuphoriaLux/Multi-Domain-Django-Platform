    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                default=20, help_text="Maximum invited guests for private event"
            ),
        ),
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True,
                help_text="The correct answer for QUIZ mode. **LEAVE BLANK for QUESTIONNAIRE mode** (all answers accepted & saved for review). Chapters 2/4/5 and types 'open_text'/'would_you_rather' auto-detect questionnaire mode.",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "guest_email",
                    models.EmailField(
                        help_text="Guest's email address", max_length=254
                    ),
                ),
                (
                    "guest_first_name",
                    models.CharField(help_text="Guest's first name", max_length=100),
                ),
                (
                    "guest_last_name",
                    models.CharField(help_text="Guest's last name", max_length=100),
                ),
                (
                    "invitation_code",
                    models.UUIDField(
                ...
                (
                    "approval_notes",
                    models.TextField(
                        blank=True, help_text="Internal notes about approval/rejection"
                    ),
                ),
                (
                    "coach_notes",
                    models.TextField(
                        blank=True, help_text="Coach notes about the guest"
                    ),
                ),
                (
                    "created_user",
