"""
Post-event connections and messaging views for Crush.lu

Handles event attendee listings, connection requests, mutual matching,
and direct messaging between connections.
"""
...
from ..models import (
    MeetupEvent, EventRegistration, EventConnection, ConnectionMessage, CrushProfile
)
from ..decorators import crush_login_required
from ..notification_service import notify_new_connection, notify_connection_accepted, notify_new_message
...
def event_attendees(request, event_id):
    ...
    return render(request, 'crush_lu/connections/event_attendees.html', context)
...
def my_connections(request):
    ...
    return render(request, 'crush_lu/connections/my_connections.html', context)
...
def connection_detail(request, connection_id):
    ...
    return render(request, 'crush_lu/connections/connection_detail.html', context)
