...
def oauth_popup_callback(request):
    ...
    return render(request, 'crush_lu/onboarding/oauth_popup_callback.html', {
...
def oauth_popup_error(request):
    ...
    return render(request, 'crush_lu/onboarding/oauth_popup_error.html', {
...
def oauth_landing(request):
    ...
    response = render(request, 'crush_lu/onboarding/oauth_landing.html', {
        'redirect_url': redirect_url,
        'is_popup': is_popup,
        'has_profile': has_profile,
        'user_name': user_name,
