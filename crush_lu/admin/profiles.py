...
class CrushCoachAdmin(admin.ModelAdmin):
    ...
    get_user_link.short_description = 'User / Links'
...
class CrushProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Quick Status', {
            ...
            'description': 'At-a-glance status overview',
        }),
        ('User Account Information', {
            'fields': ('get_user_account_info',),
            'description': 'Django User account details with link to full user record',
        }),
        ('Profile Basics', {
        ...
        ('Coach Assignment', {
            ...
            'description': 'View which coach is assigned to review this profile.',
        }),
        ('Profile Completion', {
        ...
        ('Event Registrations', {
            ...
            'description': 'User event history and registrations',
        }),
        ('Connections', {
        ...
        ('Journey Progress', {
            ...
            'description': 'Interactive journey experiences (Wonderland, etc.)',
        }),
    )
    ...
    def get_user_account_info(self, obj):
        ...
        '''
        return format_html(html)
    get_user_account_info.short_description = 'User Account Details'
    ...
    def get_journey_progress(self, obj):
        ...
        html += '</div>'
        return format_html(html)
    get_journey_progress.short_description = 'Journey Progress'
    ...
    def get_quick_status_summary(self, obj):
        ...
        '''
        return format_html(html)
    get_quick_status_summary.short_description = 'Status Summary'
