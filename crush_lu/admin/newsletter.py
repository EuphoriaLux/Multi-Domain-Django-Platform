...
def _send_newsletter_in_thread(newsletter):
    ...
    try:
        ...
        logger.exception("Background newsletter send failed for #%s", newsletter.pk)
    finally:
        close_old_connections()
...
class NewsletterAdmin(admin.ModelAdmin):
    ...
    def email_preview(self, obj):
        ...
        preview_url = reverse("crush_admin:crush_lu_newsletter_preview", args=[obj.pk])
        ...
        return mark_safe(header + tab_buttons + "</div>" + panels + script + "</div>")
    ...
    def _render_event_preview(self, newsletter, first_name="Preview", lang="en"):
        ...
        with translation.override(lang):
            ...
            return render_to_string("crush_lu/emails/event_announcement.html", context)
