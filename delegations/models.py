...
class DelegationProfile(models.Model):
    ...
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="delegation_profile"
    )
    ...
    microsoft_tenant_id = models.CharField(
        max_length=100, blank=True, help_text="User's Microsoft tenant ID"
    )
    ...
    manually_approved = models.BooleanField(
        default=False, help_text="Admin manually approved this user"
    )
    manually_blocked = models.BooleanField(
        default=False, help_text="Admin manually blocked this user"
    )
...
class AccessLog(models.Model):
    ...
    profile = models.ForeignKey(
        DelegationProfile, on_delete=models.CASCADE, related_name="access_logs"
    )
