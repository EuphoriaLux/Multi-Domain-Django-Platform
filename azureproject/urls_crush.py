...
urlpatterns = (
    ...
    + [
        ...
        path(
            "api/profile/save-step4/",
            views_profile.save_profile_step4,
            name="api_save_profile_step4",
        ),
        path(
        ...
        path(
            "api/quiz/<int:quiz_id>/regenerate-tables/",
            api_quiz.regenerate_tables,
            name="api_quiz_regenerate_tables",
        ),
